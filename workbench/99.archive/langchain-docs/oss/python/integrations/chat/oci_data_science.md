<!-- source: langchain-ai/docs  src/oss/python/integrations/chat/oci_data_science.mdx -->
...
This will help you get started with OCIModelDeployment [chat models](/oss/langchain/models). For detailed documentation of all `ChatOCIModelDeployment` features and configurations, see the [langchain-oci package](https://github.com/oracle/langchain-oracle/tree/main/libs/oci).
