<!-- source: langchain-ai/docs  src/oss/python/integrations/tools/TEMPLATE.mdx -->
<!-- commit: 3e4afc107f12c31131662fa178b53d7a14b7e681 -->
<!-- fetched: 2026-09-11 -->

---
title: "(MODULE_NAME) integration"
description: "Integrate with the (MODULE_NAME) tool using LangChain Python."
---
---
...
This guide provides a quick overview for getting started with the (MODULE_NAME) [tool](/oss/langchain/tools). For a detailed listing of all (MODULE_NAME) features, parameters, and configurations, head to the [(MODULE_NAME) API reference](<LINK>).
...
- [MCP Toolbox](/oss/integrations/tools/mcp_toolbox)
