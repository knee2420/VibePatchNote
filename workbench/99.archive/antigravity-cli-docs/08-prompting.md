...
source: "https://antigravity.google/docs/cli/prompting/"
...
> The `Esc` key acts as a global escape hatch. Pressing `Esc` instantly cancels any active agent turn, closes overlay panels, and returns focus to a clean prompt box.
