...
source: "https://antigravity.google/docs/cli/commands/agents/"
section: "Commands"
---
...
> Note: **Subagent Specification:** For complete details on subagent lifecycle states, inter-agent communication, and custom Markdown agent specifications (`.md`), consult the [Antigravity 2.0 Subagents Documentation](https://antigravity.google/docs/subagents) and [CLI Subagents Guide](https://antigravity.google/docs/cli/subagents).
