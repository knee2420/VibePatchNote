...
source: "https://antigravity.google/docs/cli/subagents/"
...
**Note:** For core platform capabilities, subagent lifecycle state diagrams, inter-agent messaging, and nesting depth limits, see the [Antigravity 2.0 Subagents Documentation](https://antigravity.google/docs/subagents).
