...
import type { ReferenceDocumentData } from '@/entities/reference-document';

import { useDocumentLayout } from '../model/useDocumentLayout';
import { useNodeWheelScroll } from '../model/useNodeWheelScroll';
...
/**
 * ReferenceDocumentCard (FSD Widget)
 * 
 * 마네킹(참고 문서 도메인)에 다양한 기능(크기 핏, 휠 가로채기, 펼침 앵커 등)을 조립한
 * 완성형 캔버스 노드 위젯.
 */
