...
* **대상 컴포넌트**: `apps/web/src/widgets/editor-lab-workspace/ui/IdeResourceManager.tsx`, `apps/web/src/app/styles/index.css`
* **선행 패치**: `workbench/03.patch_note/2026-09-14/document_recipe_checkpoints.md`
...
- ![사용자 첨부 캡처](file:///C:/Users/knee2/.gemini/antigravity-ide/brain/20a6f03d-4957-4b67-8e1a-eab034a4f543/.user_uploaded/media_1789618862658.png)
  *(사용자가 빨간색 화살표로 표시한 가로 스크롤바 필요 위치 및 4개/9개 파일 절삭 현상)*
